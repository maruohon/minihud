...
public class ShapeSpawnSphere extends ShapeBase
{
    ...
    public ShapeSpawnSphere(ShapeTypes shape, Color4f color, int radius)
    {
        super(shape, color);

        this.radius = radius;
        this.radiusSq = (double) radius * (double) radius;
    ...
    private boolean movePositionToRing(BlockPos.MutableBlockPos posMutable, EnumFacing dir)
    {
        ...
        int zNext = z;
        int failsafe = 0;
        final int failsafeMax = this.radius + 5;
