...
public enum InfoToggle implements IConfigInteger, IHotkeyTogglable
{
    ...
    CHUNK_SECTIONS          ("infoChunkSections",           false, 14, "H,C", "Show the currently rendered number of\nChunk sections (the C value from F3)"),
    ...
    ENTITY_REG_NAME         ("infoEntityRegistryName",      false, 24, "H,E", "Show the registry name of the entity\nthe player is currently looking at"),
