...
{
    OVERLAY_STRUCTURE_BURIED_TREASURE   ("Buried Treasure", "", "#302298E6", "#302298E6", "Toggle Buried Treasure structure bounding boxes rendering", "Desert Pyramid"),
    ...
    OVERLAY_STRUCTURE_MINESHAFT         ("Mineshaft",       "", "#30F8D650", "#30F8D650", "Toggle Mineshaft structure bounding boxes rendering", "Mansion structures"),
    ...
    OVERLAY_STRUCTURE_OCEAN_RUIN        ("Ocean Ruin",      "", "#300FAD83", "#300FAD83", "Toggle Ocean Ruin structure bounding boxes rendering", "Ocean Monument"),
    ...
    OVERLAY_STRUCTURE_SHIPWRECK         ("Shipwreck",       "", "#30EB1995", "#30EB1995", "Toggle Shipwreck structure bounding boxes rendering", "Stronghold"),
