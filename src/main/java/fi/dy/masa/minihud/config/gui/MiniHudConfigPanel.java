...
public class MiniHudConfigPanel extends AbstractConfigPanel
{
    ...
    public String getPanelTitle()
    {
        ...
        {
            return "MiniHUD options - " + this.selectedSubPanel.getPanelTitle();
        }

        return "MiniHUD options";
    }
    ...
    {
        private final MiniHudConfigPanel mainPanel;

        public ButtonListenerPanelSelection(MiniHudConfigPanel mainPanel)
        {
