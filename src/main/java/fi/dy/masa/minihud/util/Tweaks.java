...
public class Tweaks
{
    ...
    {
        if (posFirst != null && ConfigsGeneric.TWEAK_FAST_BLOCK_PLACEMENT.getBooleanValue())
        {
            ...
            EnumHand hand)
    {
        ...
        if (ConfigsGeneric.TWEAK_FLEXIBLE_BLOCK_PLACEMENT.getBooleanValue() && GuiScreen.isAltKeyDown())
        {
