...
public class StructureData
{
    ...
    private final MutableIntBoundingBox mainBox;
    private final ImmutableList<MutableIntBoundingBox> componentBoxes;

    private StructureData(MutableIntBoundingBox mainBox, ImmutableList<MutableIntBoundingBox> componentBoxes)
    {
    ...
    public ImmutableList<MutableIntBoundingBox> getComponents()
    {
    ...
    {
        ImmutableList.Builder<MutableIntBoundingBox> builder = ImmutableList.builder();
