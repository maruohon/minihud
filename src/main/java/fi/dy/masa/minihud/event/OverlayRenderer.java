...
import fi.dy.masa.minihud.util.Tweaks.HitPart;
...
public class OverlayRenderer
{
    public static void renderOverlays(int mask, Minecraft mc, double chunkOverlayY, float partialTicks)
    {
        ...
        {
            renderBlockPlacementOverlay(mc.objectMouseOver.getBlockPos(), mc.objectMouseOver.sideHit,
                    mc.objectMouseOver.hitVec, dx, dy, dz);
        }
    ...
    private static void renderBlockPlacementOverlay(BlockPos pos, EnumFacing side, Vec3d hitVec, double dx, double dy, double dz)
    {
